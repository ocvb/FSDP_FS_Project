    ...
    return (
        <div
            ...
            <div
                ...
                >
                    <MenuItem onMouseOver={handlePrefetchUsers} value={0}>Users</MenuItem>
                    <MenuItem onMouseOver={handlePrefetchEvents} value={1}>Events</MenuItem>
            ...
            <div style={{ position: 'relative', height: 'calc(100vh - 135px - 2rem)', width: '100%', backgroundColor: "white" }}>
                ...
                {snackbar != null && (
                    <Snackbar open anchorOrigin={{ vertical: 'bottom', horizontal: 'center' }}
                        ...
                        <Alert onClose={() => setSnackbar(null)} {...(snackbar as object)} sx={{ width: '100%' }} />
                    </Snackbar>
                )}
            </div>
        </div >
